...
def import_to_tensorboard(model_dir, log_dir, tag_set):
  ...
  Usage:
    ...
    python object_detection\export_inference_graph.py --input_type=image_tensor --pipeline_config_path=object_detection\samples\configs\ssdlite_mobilenet_v3_small_320x320_coco.config --trained_checkpoint_prefix=object_detection\model\model.ckpt --ouput_directory=object_detection\model_out
  """
